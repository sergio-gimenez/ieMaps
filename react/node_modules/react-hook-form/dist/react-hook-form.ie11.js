...
function useForm(_a) {
    ...
    var defaultInputValuesRef = useRef({});
    ...
    var setDirty = function (name) {
        ...
        var isDirty = defaultInputValuesRef.current[name] !==
    ...
    var executeSchemaValidation = useCallback(function (payload, shouldRender) { return __awaiter(_this, void 0, void 0, function () {
        var fieldErrors, isMultipleFields, names, validFieldNames, fieldName;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (isMultipleFields) {
                        ...
                        renderBaseOnError(fieldName, fieldErrors[fieldName]
                            ? (_a = {}, _a[fieldName] = fieldErrors[fieldName], _a)
                            : {}, shouldRender);
                    }
    ...
    var reset = useCallback(function (values) {
        ...
        if (values) {
            ...
            defaultInputValuesRef.current = __assign({}, values);
